public class Main_2 {
    public static void main(String[] args) {
        // Объектная ссылка равна null
        Integer objInt = null;

        try {
            // Здесь происходит автораспаковка (unboxing).
            // Java пытается неявно вызвать objInt.intValue(), что и приводит к NPE.
            int primitiveInt = objInt;
